    ...
    >
          ...
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-400 truncate">Total Pages</dt>
                  <dd className="text-lg font-medium text-white">{totalPages}</dd>
                </dl>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gray-800 border border-gray-700 overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-400 truncate">Blocks</dt>
                  <dd className="text-lg font-medium text-white">0</dd>
                </dl>
              </div>
            </div>
      ...
      <div className="bg-gray-800 border border-gray-700 shadow rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          <h3 className="text-lg leading-6 font-medium text-white mb-4">Recent Pages</h3>
          {recentPages.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="mt-1 text-sm text-gray-400">Get started by creating your first page.</p>
              <div className="mt-6">
                ...
                {recentPages.map((page) => (
                  <li key={page.id} className="py-4">
                    <div className="flex items-center space-x-4">
                      <div className="flex-shrink-0">
                        <div className="h-8 w-8 bg-purple-900/30 border border-purple-800 rounded-full flex items-center justify-center">
        ...
        <div className="bg-gray-800 border border-gray-700 overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <h3 className="text-sm font-medium text-white">Create Page</h3>
                <p className="text-sm text-gray-400">Add a new page to your site</p>
              </div>
            </div>
            <div className="mt-4">
        ...
        <div className="bg-gray-800 border border-gray-700 overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <h3 className="text-sm font-medium text-white">Create Block</h3>
                <p className="text-sm text-gray-400">Add a reusable content block</p>
              </div>
            </div>
            <div className="mt-4">
              <button className="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
        ...
        <div className="bg-gray-800 border border-gray-700 overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <h3 className="text-sm font-medium text-white">Upload Asset</h3>
                <p className="text-sm text-gray-400">Add images, videos, or files</p>
              </div>
            </div>
            <div className="mt-4">
              <button className="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
